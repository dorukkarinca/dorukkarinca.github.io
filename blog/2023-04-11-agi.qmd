...
If you're wondering how GPT is doing with the styrofoam riddle, you can paste it on OpenAI Playground Chat though I'll save you a few clicks. Setting temperature to zero, GPT-3.5 incorrectly says the answer is "ball" whereas GPT-4 correctly says "table".
...
LLMs don't take these steps. How it works is akin to predictive text on a mobile keyboard: given the previous words in the sequence, it tries to come up with words that have high probability of occurring. As a result, GPT-3.5 gives you the incorrect answer because balls made out of styrofoam are somewhat more likely in the training data than tables made out of styrofoam. This makes sense; I can't remember the last time I saw a table made out of styrofoam, and neither can the model. It may be possible to *teach* the model the correct answer; in fact, we can already see that GPT-4 has corrected this mistake. However **our world is inundated with Winograd-like realities** and micro-facts that are constantly evolving and not always written down. So I doubt how scalable this solution will be.
